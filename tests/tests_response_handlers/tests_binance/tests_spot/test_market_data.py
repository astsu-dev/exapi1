...
import pytest
from exapi.response_handlers.binance.spot.market_data import \
    BinanceSpotMarketDataResponseHandler
...
HANDLE_RESPONSE_PATH: Final[str] = "exapi.response_handlers.binance.spot.market_data.handler.BinanceSpotMarketDataResponseHandler.handle_response"


@pytest.fixture(scope="module")
def handler() -> BinanceSpotMarketDataResponseHandler:
    return BinanceSpotMarketDataResponseHandler()


@pytest.mark.asyncio
async def test_handle_ping_response(handler: BinanceSpotMarketDataResponseHandler) -> None:
...
@pytest.mark.asyncio
async def test_handle_get_server_time_response(handler: BinanceSpotMarketDataResponseHandler) -> None:
...
@pytest.mark.asyncio
async def test_handle_get_average_price_response(handler: BinanceSpotMarketDataResponseHandler) -> None:
...
@pytest.mark.asyncio
async def test_handle_get_candles_response(handler: BinanceSpotMarketDataResponseHandler) -> None:
    expected = [
        BinanceCandleModel(
            open_time=1500,
            open=Decimal("1500.5"),
...
@pytest.mark.asyncio
async def test_handle_get_exchange_info_response(handler: BinanceSpotMarketDataResponseHandler) -> None:
...
@pytest.mark.asyncio
async def test_handle_get_order_book_ticker_response(handler: BinanceSpotMarketDataResponseHandler) -> None:
...
@pytest.mark.asyncio
async def test_handle_get_order_book_tickers_response(handler: BinanceSpotMarketDataResponseHandler) -> None:
    expected = [
        BinanceOrderBookTickerModel(
            symbol="BTCUSDT",
            bid_price=Decimal("1500.5"),
...
@pytest.mark.asyncio
async def test_handle_get_order_book_response(handler: BinanceSpotMarketDataResponseHandler) -> None:
    orders = [
        BinanceOrderBookOrderModel(
...
@pytest.mark.asyncio
async def test_handle_get_price_ticker_response(handler: BinanceSpotMarketDataResponseHandler) -> None:
...
@pytest.mark.asyncio
async def test_handle_get_price_tickers_response(handler: BinanceSpotMarketDataResponseHandler) -> None:
    expected = [
...
@pytest.mark.asyncio
async def test_handle_get_ticker_price_change_stat_response(handler: BinanceSpotMarketDataResponseHandler) -> None:
...
@pytest.mark.asyncio
async def test_handle_get_tickers_price_change_stat_response(handler: BinanceSpotMarketDataResponseHandler) -> None:
    expected = [
        BinanceTickerPriceChangeStatModel(
            symbol="BTCUSDT",
            price_change=Decimal("178.0"),
...
@pytest.mark.asyncio
async def test_handle_get_trades_response(handler: BinanceSpotMarketDataResponseHandler) -> None:
    expected = [
        BinanceTradeModel(
            id=5,
            price=Decimal("100.3"),
...
@pytest.mark.asyncio
async def test_handle_get_aggregate_trades_response(handler: BinanceSpotMarketDataResponseHandler) -> None:
    expected = [
