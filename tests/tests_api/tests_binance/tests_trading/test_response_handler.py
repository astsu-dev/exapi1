...
def handler() -> BinanceTradingResponseHandler:
    return BinanceTradingResponseHandler()


@pytest.mark.asyncio
async def test_handle_new_test_order_response(handler: BinanceTradingResponseHandler) -> None:
...
@pytest.mark.asyncio
async def test_handle_new_order_response(handler: BinanceTradingResponseHandler) -> None:
...
@pytest.mark.asyncio
async def test_handle_query_order_response(handler: BinanceTradingResponseHandler) -> None:
...
@pytest.mark.asyncio
async def test_handle_get_current_open_orders_response(handler: BinanceTradingResponseHandler) -> None:
    expected = [
...
@pytest.mark.asyncio
async def test_handle_get_all_orders_response(handler: BinanceTradingResponseHandler) -> None:
    expected = [
        BinanceOrderInfoModel(
            symbol="BTCUSDT",
            order_id=1234,
...
@pytest.mark.asyncio
async def test_handle_get_account_info_response(handler: BinanceTradingResponseHandler) -> None:
...
@pytest.mark.asyncio
async def test_handle_get_trades_response(handler: BinanceTradingResponseHandler) -> None:
    expected = [
        BinanceAccountTradeModel(
            symbol="BTCUSDT",
            id=5,
